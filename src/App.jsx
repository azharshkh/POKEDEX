...
const arrowSound = new Audio(import.meta.env.BASE_URL + 'arrow.mp3');
const okSound = new Audio(import.meta.env.BASE_URL + 'ok.mp3');
...
function App() {
  ...
  return (
    ...
    >
      {/* Background image */}
      <img
        src={import.meta.env.BASE_URL + 'img.webp'}
        alt="Pokedex"
        style={{
          position: 'absolute',
          top: '-50px',
